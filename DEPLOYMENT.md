...
`05_results/roi/cost_benefit_analysis.csv` projects ≈ $80k/yr savings ($79,930, a
90% first-year ROI) for a 180k-job/yr cluster **under strong assumptions** (linear
...
20 steps and regenerates every result cited in this guide. Check the output against
the committed artefacts with `python tools/verify_artifacts.py --quick`.
