...
| The model is **retrained on your own workload** | Cross-dataset R² vs even a schema-matched proxy is ≈ 0.02; OOD mean R² < 0 across 72 shifted scenarios (`phases_22_30/phase_23_sensitivity/`) |
