...
\begin{enumerate}
  \item \textbf{The degeneracy, stated and measured} (\S\ref{sec:degeneracy}).
        ...
        deterministic function of the requested size. A ten-job queue receives
...
\midrule
Synthetic & mean wait & $+0.80\%$ & $2.6\times10^{-16}$ & equivalent \\
Synthetic & bnd.\ slow. & $+0.69\%$ & $3.8\times10^{-18}$ & equivalent \\
